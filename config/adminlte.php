...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'header' => 'Cursos y Asignaturas',
        ],
        [
            'text' => 'Configuración de Cursos',
            'url'  => 'courses_settings',
            'icon' => 'fas fa-fw fa-cogs',
            'active' => ['courses_settings', 'courses_settings/*'],
            // 'can'  => 'courses_settings.index',
        ],
        [
            'text' => 'Asignaturas',
            'url'  => 'subjects',
        ...
        [
            ...
            'active' => ['trimesters', 'trimesters/*'],
        ],
        [
            'text' => 'Calificaciones',
            'url'  => 'califications',
            'icon' => 'fas fa-fw fa-clipboard-list',
            'active' => ['califications', 'califications/*'],
            // 'can'  => 'grades.index',
        ],
        // [
        //     'text' => 'Roles',
